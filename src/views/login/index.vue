        ...
        <div class="content">
          ...
          >
            <el-form-item label="用户名" prop="username"
              ><el-input v-model="ruleForm.username" style="width: 100%; height: 40px">
                <template slot="prepend"
                  ><Icon icon-class="user" class="erweima"></Icon></template></el-input
            ></el-form-item>
            ...
            <el-form-item label="验证码" prop="captcha">
              <el-input v-model="ruleForm.captcha" style="width: 65%; height: 40px"></el-input>
            ...
            <div class="login-btn">
              ...
              <el-button type="primary" @click="login()" @keydown.enter.native="login()"
                >登录</el-button
              >
            </div>
          </el-form>
